...
type StripeWelcomeEmailProps = {
  logoUrl: string
}

export const StripeWelcomeEmail = ({ logoUrl }: StripeWelcomeEmailProps) => (
  <Html>
    <Head />
    ...
    <Body style={main}>
      <Container style={container}>
        <Section style={box}>
          <Img src={logoUrl} width="49" height="21" alt="Stripe" />
          <Hr style={hr} />
...
const previewProps: StripeWelcomeEmailProps = {
  logoUrl: "https://seeklogo.com/images/S/stripe-logo-C409DC9652-seeklogo.com.png",
}

StripeWelcomeEmail.PreviewProps = previewProps
